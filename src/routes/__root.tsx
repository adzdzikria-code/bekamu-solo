...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bekamu Solo — Terapi Bekam Profesional & Sesuai Sunnah" },
      { name: "description", content: "Bekamu Solo adalah pusat terapi bekam profesional di Solo Raya. Higienis, aman, nyaman, dan sesuai sunnah. Melayani bekam, pijat, herbal, dan home service." },
